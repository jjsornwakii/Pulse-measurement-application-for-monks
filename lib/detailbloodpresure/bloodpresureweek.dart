...
class Bloodpresureweek extends StatefulWidget {
  const Bloodpresureweek({super.key});

  @override
  _Bloodpresureweek createState() => _Bloodpresureweek();
}

class _Bloodpresureweek extends State<Bloodpresureweek> {
  ...
  Future<void> fetchChartData() async {
    final url = 'http://$server:$port/$apipath/chartpressure.php';
