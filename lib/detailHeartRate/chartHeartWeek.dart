...
class ChartColumnData {
  ...
  ChartColumnData(this.dayName, this.heartRate);
}

class Chartheartweek extends StatefulWidget {
  const Chartheartweek({super.key});

  @override
  _ChartheartweekState createState() => _ChartheartweekState();
}

class _ChartheartweekState extends State<Chartheartweek> {
  ...
  Future<void> fetchChartData() async {
    final url = 'http://$server:$port/$apipath/chartHeartWeek.php';
        ...
        if (dailyStats != null) {
          setState(() {
            ...
            chartData = dailyStats.map((item) {
              ...
              return ChartColumnData(dayName, heartRate);
            }).toList();
          });
        } else {
